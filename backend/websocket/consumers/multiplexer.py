...
multiplexer_routings = [
    ...
    route('room-ai-add', 'websocket.consumers.room_consumers.room_ai_add_consumer'),
    route('room-ai-delete', 'websocket.consumers.room_consumers.room_ai_delete_consumer'),
